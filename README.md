...
Это минимально простое тестовое приложение интернет-маркета.
Цель попробовать технологии NUXT, TS, VUE3, Vuetify, scss
...
### Данные
Маркет использует данные демо-магазина:
- fakestoreapi_com
